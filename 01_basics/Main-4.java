...
// 4. Dans le main, utiliser la fonction compter avec un minimum aléatoire entre 0 et 10 
// et un maximum aléatoire entre 15 et 25
         int aleatoireMin = randInt(0,10);
        int aleatoireMax = randInt(15,25);
    
        System.out.printf("min %d max %d\n",aleatoireMin,aleatoireMax);
        compter(aleatoireMin,aleatoireMax);
    }
    // ---------------------------------------------------------------------------------
    public static int randInt(int minValue, int maxValue) {
// 3. Créer une fonction "randint" prenant en paramètre deux entier min et max et 
// retournant une valeur aléatoire entre min et max
        return   (int)(Math.random() * (maxValue + 1-minValue) + minValue );  
    }
    // ---------------------------------------------------------------------------------
    // ---------------------------------------------------------------------------------
    public static void compter(int min , int max ) {
        // 1. Créer une fonction "compter" qui affiche les nombres de 0 à 10
        // 2. Modifier la fonction compter pour qu'elle prennent en paramètre un min et un max. 
        // Elle comptera de min jusqu'à max.
    ...
    // Génération d'un nombre entier aléatoire entre min et max
        ...
        int minValueRandomCase = 5;
        int maxValueRandomCase = 20 ;

        int randomCase = (int)(Math.random() * ( maxValueRandomCase + 1 - minValueRandomCase ) + minValueRandomCase ) ;
        System.out.printf(" Taille du tableau [%d] \n",randomCase);

        int[] myIntArray = new int [randomCase];
        int total = 0 ; 
        int minInArray =0 ; 
        int maxInArray  =0; 
        ...
        // 2. Remplir chacunes de ces cases par un nombre entre 10 et 50, de manière aléatoire
            ...
            myIntArray[index] = (int)(Math.random() * ( maxValue + 1 - minValue ) + minValue ) ;
            if (index <=0 ){
                minInArray =  myIntArray[index] ; 
                minInArray =  myIntArray[index] ; 
            }
            else {
                if (minInArray > myIntArray[index]) {
                    minInArray =  myIntArray[index];
                } else if (maxInArray < myIntArray[index]) {
                    maxInArray =  myIntArray[index];

                } 
            }
            System.out.printf(" myIntArray[%d] %d \n",index,myIntArray[index]);
            total += myIntArray[index] ; 
        }
            // 4. Afficher la somme de ces nombres
            // 5. Afficher la valeur maximale et minimale
        System.out.printf(" min %d- max %d  total %d  moyen %d\n",
        minInArray,maxInArray,total,total/myIntArray.length);
    ...
    public static void exercice13() {
        ...
        int tabSize ;
        System.out.print(" tabSize svp :" ) ;
        tabSize= myScan.nextInt();
        int[] myIntArray = new int [tabSize];
        int minVal = 0 ;
        int maxVal = 10 ;
        ...
        for (int index = 0 ; index < myIntArray.length ; index++){
            myIntArray[index] = randInt (minVal,minVal) ; 
        }
        for (int index = 0 ; index < myIntArray.length ; index++){
            System.out.printf("tableau[%d] = %d", index,  myIntArray[index] ) ;
            System.out.printf("---%d",randInt (minVal,minVal));
            System.out.printf("---%d-- \n",(int)(Math.random() * (maxVal+1-minVal) + minVal ));
    ...
    public static void exercice8() {
        ...
        int[] myIntArray ={5, 87, -20, 71, -9 , 25};
        ...
        System.out.printf("Q2 Afficher les cases 3 : %d  et 5 %d\n",myIntArray[3],myIntArray[5]);
            ...
            myIntArray[3] = myIntArray[3] + myIntArray[0];  //22
